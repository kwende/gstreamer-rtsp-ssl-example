...
main (int argc, char *argv[])
{
	...
	//std::string gioDirectory = gRoot + "/lib/gio/modules";
	SetEnvironmentVariableA("GIO_MODULE_DIR", "D:/gstreamer/1.0/x86_64/lib/gio/modules");
	SetEnvironmentVariableA("GIO_EXTRA_MODULES", "D:/gstreamer/1.0/x86_64/lib/gio/modules");
    ...
    GTlsDatabase* database =	 (rtsp_config.rtsp_ca_cert, &error);
    //GTlsDatabase* database = g_tls_file_database_new ("/home/enthusiasticgeek/gstreamer/cert/toyCA.pem", &error);
